                            ...
                            if roll_number in text:
                                ...
                                for line in lines:
                                    if roll_number in line:
                                        # Check for any valid grade in the line
                                        if any(grade in line for grade in valid_grades):
...
output_pdf_path = r'C:\Users\Hp\Documents\projects\python\Pokhara University Result Organiser\Merged.pdf'
